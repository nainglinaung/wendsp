...
@section('content')
    <form action="{{route('book_add')}}" method="POST" enctype="multipart/form-data">
            <div class="row" id="publish-position">
                <button type="submit" class="btn btn-default right" id="add_book">PUBLISH</button>
            </div>
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="assigned" name="assigned">
                        {{ csrf_field() }}
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="buyprice" name="buy_price" >
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sellprice" name="sale_price">
                    </div>
                    </div>

                    <div class="col-sm-6">
                    <label class="control-label">Select Cover</label>
                    <input id="input-2" name="book_cover" type="file" class="file" multiple data-show-upload="false" data-show-caption="true">
                    </div>
