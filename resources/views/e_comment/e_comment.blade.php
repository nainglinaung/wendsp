...
@section('content')
            <div class="row">
                ...
                <div class="list">
                    ...
                    <!--comment list-->
                    @foreach($e_comments as $e_comment)
                    <div class="list-content">
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="name-detail">
                                    ...
                                    <div class="team-name comment">
                                        <span>Comment ID - {{$e_comment->e_comment_id}}</span>
                                        <span>{{$e_comment->email}}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-3">
                            <?php 
                            $book_name=DB::table('e_books')->where('e_book_id','=',$e_comment->e_book_id)->value('e_book_title');
                            echo $book_name;
                            ?>
                            </div>
                            <div class="col-sm-2">
                                {{$e_comment->created_at}}
                            </div>
                        </div>
