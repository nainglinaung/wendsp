...
@section('content')
    <form action="{{route('e_book_add')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div class="col-sm-6">
                        <label for="book_cover">Book PDF Upload:</label>
                        <input type="file"  id="book_cover" name="book_source">
