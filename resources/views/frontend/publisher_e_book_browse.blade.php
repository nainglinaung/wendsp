...
<head>
    ...
    <title>WE Distribution | @foreach($publisher_many_books as $title) {{$title->publisher_name}} @endforeach</title>
...
<div class="container content">
    ...
    @foreach($publisher_many_books as $publisher_many_book)
        <div>{{$publisher_many_book->category_name}}</div>
    @endforeach
        <div>
    ...
    <div class="row">
        ...
        <div class="col-md-9" id="browse-list">
            ...
            @foreach($publisher_many_books as $publisher_many_book)
            @foreach($publisher_many_book->e_books as $book)
                <div>
                    <div>
