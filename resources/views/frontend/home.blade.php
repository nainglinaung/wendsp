    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <div id="top-10-month-rect">
                ...
                @foreach($top_10_panel->book as $top_10_book)
                    <span id="top-10-img-preview">
                    <a href="/book_detail/{{$top_10_book->book_id}}/{{$top_10_book->book_title}}">
                        <img src="book_cover/{{$top_10_book->book_cover}}">
                    </a>
                    </span>
                    <span id="top-10-book-detail">
                        <div>{{$top_10_book->book_title}}</div>
                        <div>{{$top_10_book->author_name}}</div>
                        <div>
                        <?php $rating=DB::table('comments')->where('book_id',$top_10_book->book_id)->avg('rating');?>
                        <input type="number" name="rating" class="rating" data-clearable="remove" value="<?php echo floor($rating); ?>" data-readonly />

                        </div>
                        <div>{{$top_10_book->sale_price}}Ks</div>
                    </span>
                @endforeach
                @endforeach
                </div>
                ...
                @foreach($top_10_image->book as $image)
                <a href="/book_detail/{{$image->book_id}}/{{$image->book_title}}">
                    <img src="book_cover/{{$image->book_cover}}" alt="book" class="img-responsive">
                </a>
                @endforeach
                @endforeach
                </div>
                        ...
                        <div class="carousel-inner">
                            ...
                            <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <div>
                                            <a href="/book_detail/{{$latest_book->book_id}}/{{$latest_book->book_title}}"><img src="book_cover/{{$latest_book->book_cover}}"></a>
                                        </div>
                                        <div class="thumbnail-detail">
                                            <div class="row">
                                                <a href="/book_detail/{{$latest_book->book_id}}/{{$latest_book->book_title}}" class="col-sm-10">{{$latest_book->book_title}}</a>
                                            </div>
                                            <div>
                                                <a href="/author/{{$latest_book->author_id}}/{{$latest_book->author->author_name}}">{{$latest_book->author->author_name}}</a>
                                            </div>
                                            <div>
                    ...
                    <div class="carousel slide best-latest-slide" id="best-slide-list">
                        ...
                        <div class="carousel-inner">
                            <div>
                                ...
                                @foreach($books->book as $best_selling)
                                    <div class="col-sm-2">
                                        <div>
                                            <a href="/book_detail/{{$best_selling->book_id}}/{{$best_selling->book_title}}"><img src="book_cover/{{$best_selling->book_cover}}"></a>
                                        </div>
                                        <div class="thumbnail-detail">
                                            <div class="row">
                                                <a href="/book_detail/{{$best_selling->book_id}}/{{$best_selling->book_title}}" class="col-sm-10">{{$best_selling->book_title}}</a>
                                            </div>
                                            <div>
                                                <a href="/author/{{$best_selling->author_id}}/{{$best_selling->author_name}}">{{$best_selling->author_name}}</a>
                                            </div>
                                            <div>
                                            <?php $rating_best_book=DB::table('comments')->where('book_id',$best_selling->book_id)->avg('rating');?>

                                                <input type="number" name="rating" class="rating" data-clearable="remove" value="<?php echo floor($rating_best_book); ?>" data-readonly />
                                            </div>
                                            <div>
                                                {{$best_selling->sale_price}}Ks
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
        ...
        <div class="col-md-9" id="separate-category">
            ...
            <div>
                <div class="separate-cat-title">
                    ...
                    <div><a href="/category/{{$category_many_book->category_id}}/{{$category_many_book->category_name}}" class="btn btn-default">load more</a></div>
                </div>
                <div class="custom-divider"></div>
                    ...
                    <div class="col-sm-2">
                        ...
                        <div class="thumbnail-detail">
                            ...
                            <div>
                                ...
                                <div>
                                <?php $rating_categorize_book=DB::table('comments')->where('book_id',$book->book_id)->avg('rating');?>
                            ...
                            <div>
                                {{$book->sale_price}}Ks<a href="/book_detail/{{$book->book_id}}/{{$book->book_title}}"></a>
                            </div>
                            <div>
